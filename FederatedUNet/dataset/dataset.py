...
class FederatedDataset(Dataset):
    def __init__(self, meta_path, image_path = '/nmnt/x3-hdd/data/DA/CC359/originalScaled',
                 target_path='/nmnt/x3-hdd/data/DA/CC359/Silver-standard-MLScaled', img_col='img', target_col='target'):
        '''
        ...
        self.images = [np.load(os.path.join(self.image_path, img_name)) for img_name in self.df_meta[img_col]]
        self.targets = [np.load(os.path.join(self.target_path, target_name)) for target_name in self.df_meta[target_col]]
